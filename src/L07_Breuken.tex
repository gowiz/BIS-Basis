...
\[\dfrac{\tikzmark{a}2}{\tikzmark{c}5}\qquad \begin{matrix}\tikzmark{b}\text{teller}\\\tikzmark{d}\text{noemer}\end{matrix} \]
...
\begin{exercise}
Een zak snoepjes wordt verdeeld onder 3 kinderen. Evy krijgt 8 snoepjes, Tineke krijgt er 2 minder en Nele krijgt er 3. Druk uit door middel van een breuk hoeveel snoepjes uit de zak elk kind krijgt.
\end{exercise}
...
\drawbox{4.5}{0}{6}{1}
\end{tikzpicture}}
  \item $\dfrac{1}{2}$\hspace*{1em}\raisebox{-1em}{
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\clip(0,0) rectangle (6,1);
\fillbox{0}{0}{3}{1}
\drawbox{3}{0}{6}{1}
...
\[\dfrac{2}{4}=\dfrac{2:2}{4:2}=\dfrac{1}{2} \qquad\text{ en }\qquad\dfrac{1}{2}=\dfrac{1\cdot 3}{2\cdot 3}=\dfrac{3}{6}\;.\]
...
\begin{enumerate}
  ...
  \item \begin{itemize}
    ...
    \multicolumn{2}{c}{}
    &&\multicolumn{2}{c}{$15470=2\cdot5\cdot7\cdot13\cdot17$}
    \end{tabular}
...
\begin{solution}
\begin{enumerate}
  \item $\dfrac{5}{6}=\dfrac{20}{24}$ en $\dfrac{3}{8}=\dfrac{9}{24}$

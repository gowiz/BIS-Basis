...
\subsection{Product van twee tweetermen met een paar gelijke en een paar tegengestelde termen}
...
\subsection{Het kwadraat van een tweeterm}
...
\subsubsection*{Toepassingen op beide merkwaardige producten}
...
\subsection{Het kwadraat van een veelterm}
Uitwerking:
\[
\begin{aligned}
(a+b+c)^2&=(a+b+c)(a+b+c)\\
...
\subsection{Derdemacht van een tweeterm}
...
\subsection{Product van een tweeterm met aangepaste drieterm}
We berekenen:
\[

...
% Les 25. Algemene begrippen bij het ontbinden in factoren
%
...
\begin{enumerate}
  ...
  \item $2a (x + y) - b (y + x)=(x + y) (2a - b) \text{ want } x + y = y + x$
...
\[10ax + 15x	\qquad\text{ en }\qquad	4ay + 6y\]
kunnen we reeds schrijven als een product van factoren:
\[10ax + 15x = 5x (2a + 3)	\qquad\text{ en }\qquad 4ay + 6y = 2y (2a + 3)\]

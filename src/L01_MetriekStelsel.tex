...
\subsection{De lengtematen}

\subsubsection{Even terug in de tijd}
...
\subsubsection{Overzicht van de lengtematen}
...
\textbf{Bij omzetting naar een grotere eenheid verplaatsen we de komma naar links.}
...
\subsubsection{Als er verschillende eenheden in de opgave staan}
Herleid alle getallen naar dezelfde eenheid.

\begin{voorbeeld}
\(\SI{1}{\metre}=\SI{7}{\deci\metre}+\ldots\,\si{\centi\metre}\). We herleiden naar \si{\centi\metre}: \(\SI{100}{\centi\metre}=\SI{70}{\centi\metre}+\SI{30}{\centi\metre}\).
\end{voorbeeld}
...
\begin{solution}
\(\SI{999}{\metre};\quad \SI{6}{\centi\metre};\quad \SI{5}{\centi\metre};\quad \SI{330}{\centi\metre}.\)
\end{solution}

\subsection{De massa}
We gebruiken het begrip ``massa'' in plaats van ``gewicht''. Volgens de principes van de fysica is massa een juister begrip.

\subsubsection{Overzicht van de massa's}
...
Bij soortgelijke multiplechoice-oefeningen omcirkel je het juiste antwoord. Dit soort vragen wordt dikwijls gesteld op examens.

\subsection{Vlaktematen -- Landmaten}
Vlaktematen of oppervlaktematen worden gebruikt om de oppervlakte van een figuur uit te drukken.

\subsubsection{Overzicht van de vlaktematen}
...
\begin{voorbeeld}
\(\SI{5}{\square\deca\metre}=\SI{500}{\square\metre}\) (2 rangen naar rechts of 2 nullen bijplaatsen).
\end{voorbeeld}

\begin{voorbeeld}
\(\SI{36000}{\square\centi\metre}=\ldots\,\si{\square\metre}\)
\[
...
\begin{voorbeeld}
\(\SI{0.04}{\square\hecto\metre}=\ldots\,\si{\square\deci\metre}\)
\[
...
\begin{tabular}{*{3}{c}}
  ...
  =                   &                  & =                   \\
  \(\SI{1}{\square\hecto\metre}\)            & \(\SI{1}{\square\deca\metre}\)          & \(\SI{1}{\square\metre}\)
\end{tabular}
\end{center}

\subsubsection{Herleidingen vlaktematen -- landmaten}

\textbf{Tussen landmaten onderling}
...
\textbf{Van landmaat naar vlaktemaat of omgekeerd}
...
\begin{meerkeuze}
  \item \(\SI{12}{\are}\,\SI{3}{\centi\are}\)
  \item \(\SI{1203}{\square\metre}\)
  \item \(\SI{0.123}{\hectare}\)
  \item \(\SI{12.03}{\are}\)
\end{meerkeuze}
\end{exercise}
...
\subsection{Inhoudsmaten -- Ruimtematen}
...
\subsubsection{Overzicht van de inhoudsmaten}
...
\SI{1}{\deci\litre} is gelijk aan:
\begin{meerkeuze}
  \item een honderdste liter
  \item een tiende liter
  \item honderdmaal een liter
  \item tienmaal een liter
\end{meerkeuze}

\medskip
\(\SI{5}{\litre}+\SI{32}{\deci\litre}+\SI{310}{\milli\litre}=\ ?\)
\begin{meerkeuze}
  \item \(\SI{5.630}{\litre}\)
  \item \(\SI{5.342}{\litre}\)
  \item \(\SI{11.30}{\litre}\)
...
\subsubsection{Herleiden van ruimtematen}
...
\subsubsection{Verband tussen inhoudsmaten en ruimtematen}
